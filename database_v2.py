...
#     try:
#         yy = school_year[:2]  # Take first two digits of school year
#     except:
#         yy = "25"
...
#     print("🚀 Initializing ABC Learning Center Database v2...")
...
#         strand TEXT,                    -- NULL for elem/jhs, STEM/ABM/HUMSS for shs
#         termType TEXT,                  -- Quarter or Semester
...
#         schoolID TEXT UNIQUE,                    -- e.g., 25-2018-23
#         gradeLevel TEXT,
#         section TEXT,
...
#     conn.commit()
#     conn.close()
#     print("✅ Database v2 initialized successfully with all enhancements!")
#     return True
...
def init_database_v2():
    ...
    print("🚀 Updating ABC Learning Center Database to v2.1...")
    ...
    conn.commit()
    conn.close()
    print("✅ Database successfully updated to v2.1!")
    print("Your database is now ready with the improved ENROLLMENT table.")
    return True
